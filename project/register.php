...
<body>
	...
	<div class="box">
		...
		<form action="" method="POST" class="userregistration">
			...
			<input class=" form-control" required type="email" placeholder="Email Address" name="email">
			<input class=" form-control" required type="password" placeholder="Password" name="password">

			<input type="submit" class="btn btn-primary" value="Register" name="registration">
		</form>
