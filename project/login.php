...
<body>
	...
	<div class="box">
		...
		<form action="" method="POST" class="userlogin">
			<input class="amader-input form-control" required type="email" placeholder="Email Address" name="email">
			<input class="amader-input form-control" required  type="password" placeholder="Password" name="password">
